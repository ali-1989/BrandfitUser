...
import '/screens/chatPart/chatScreenPart/chatBar.dart';
import '/screens/chatPart/chatScreenPart/chatScreenCtr.dart';
...
class ChatScreenState extends StateBase<ChatScreen> {
          ...
          children: [
              ...
              builder: (ctx, data){
                if(data == null){
                  return CircleAvatar(
                    ...
                    child: Text(chat.addressee(controller.user!.userId)?.userName.substring(0, 2)?? '',
                ...
                return GestureDetector(
                  onTap: (){
                    final view = ImageFullScreen(
                      ...
                      heroTag: '${chat.id}',
                      imageObj: chat.getAddresseeProfileFile(controller.user!.userId),
                    );
                  ...
                  child: Hero(
                    ...
                    child: CircleAvatar(
                      backgroundColor: ColorHelper.textToColor('chat${chat.id}'),
                      backgroundImage: chat.getAddresseeAvatarProvider(controller.user!.userId),
                    ),
                  ),
                );
              },
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text('${chat.addressee(controller.user!.userId)?.userName}'),
                  //Text('typing..'),
                ],
              ),
            ),
          ...
          child: StateX(
            ...
            builder: (context, ctr, data) {
              ...
              return ScrollablePositionedList.builder(
                ...
                initialScrollIndex: widget.chat.messages.length,
  ...
  Widget wrapByBubble(ChatMessageModel msg, Widget child){
    final otherSender = msg.senderIsAddressee(widget.chat);

    return ChatBubble(
      clipper: ChatBubbleClipper2(type:otherSender? BubbleType.receiverBubble: BubbleType.sendBubble),
      backGroundColor: otherSender? Colors.white: myColor.withAlpha(80),
      alignment: otherSender? Alignment.topLeft : Alignment.topRight,
  ...
  Widget addDateAndState(ChatMessageModel msg, Widget child){
    return Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: msg.senderIsAddressee(chat)? CrossAxisAlignment.end : CrossAxisAlignment.start,
      children: [
        child,
  ...
  Widget genChatView(int idx){
    final msg = widget.chat.messages[idx];
  ...
  Widget getMessageViewByType(ChatMessageModel msg, BuildContext context) {
    final isSender = msg.senderUserId == controller.user!.userId;
