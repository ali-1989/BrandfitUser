...
extension WidgetExtension on Widget {
  ...
  Widget wrapBoxBorder({
    ...
    color ??= AppThemes.currentTheme.fabBackColor;
  ...
  Widget wrapListTileTheme({
    ...
    iconColor ??= AppThemes.currentTheme.textColor.withAlpha(140);
    textColor ??= AppThemes.currentTheme.textColor;
...
extension DividerExtension on Divider {
  Divider intelliWhite() {
    ...
    if(ColorHelper.isNearColors(AppThemes.currentTheme.primaryColor,
        [Colors.grey[900]!, Colors.white, Colors.grey[600]!])) {
      replace = AppThemes.currentTheme.appBarItemColor;
    } else {
...
extension IconExtension on Icon {
  ...
  Icon whiteOrDifferentOnPrimary() {
    ...
    if(ColorHelper.isNearColors(AppThemes.currentTheme.primaryColor,
        [Colors.grey[900]!, Colors.white, Colors.grey[600]!])) {
      replace = AppThemes.currentTheme.differentColor;
    } else {
      replace = Colors.white;
    }
  ...
  Icon whiteOrDifferentOnBackColor() {
    ...
    if(ColorHelper.isNearColors(AppThemes.currentTheme.backgroundColor,
  ...
  Icon primaryOrAppBarItemOnBackColor({Color? backColor}) {
    ...
    if (ColorHelper.isNearColors(backColor, [AppThemes.currentTheme.primaryColor])) {
      replace = AppThemes.currentTheme.appBarItemColor;
    } else {
      replace = AppThemes.currentTheme.primaryColor;
    }
  ...
  Icon btnTextColor() {
    final replace = AppThemes.currentTheme.buttonTextColor;
  ...
  Icon btnBackColor() {
    final replace = AppThemes.currentTheme.buttonBackColor;
  ...
  Icon textColor() {
    final replace = AppThemes.currentTheme.textColor;
  ...
  Icon chipItemColor() {
    return Icon(
      icon,
      key: key,
      color: AppThemes.themeData.chipTheme.deleteIconColor,
      textDirection: textDirection,
      semanticLabel: semanticLabel,
      size: size,
    );
  ...
  Icon info() {
    return Icon(
      icon,
      key: key,
      color: AppThemes.currentTheme.infoTextColor,
      textDirection: textDirection,
      semanticLabel: semanticLabel,
      size: size,
    );
  ...
  Icon alpha({int alpha = 160}) {
    return Icon(
      icon,
      key: key,
      color: (color ?? AppThemes.currentTheme.textColor).withAlpha(alpha),
      textDirection: textDirection,
      semanticLabel: semanticLabel,
      size: size,
    );
  ...
  Icon rSiz(double s) {
    final cSiz = AppThemes.themeData.iconTheme.size ?? 24;
...
extension TextExtension on Text {
  Text whiteOrAppBarItemOn(Color color) {
    ...
    var ts = style ?? AppThemes.currentTheme.baseTextStyle;
  ...
  Text infoColor() {
    var ts = style ?? AppThemes.currentTheme.baseTextStyle;
    ts = ts.copyWith(color: AppThemes.currentTheme.infoTextColor);
  ...
  Text subFont() {
    ...
    ts = ts.copyWith(
        fontFamily: AppThemes.currentTheme.subTextStyle.fontFamily,
    );
  ...
  Text underLineClickable() {
    return bold()
        .fsR(4)// fs(18)
        .color(AppThemes.currentTheme.underLineDecorationColor);
  }
  ...
  Text fsR(double size, {double? max /*20*/}) {
    final ts = style ?? AppThemes.currentTheme.baseTextStyle;
    var siz = ts.fontSize;
    siz ??= AppThemes.currentTheme.baseTextStyle.fontSize;
...
extension AutoSizeTextExtension on AutoSizeText {
  AutoSizeText whiteAppBarOnPrimary() {
    Color replace;
  ...
  AutoSizeText whiteDifferentOnPrimary() {
    Color replace;
  ...
  AutoSizeText whiteDifferentOnBackColor() {
    Color replace;
  ...
  AutoSizeText primaryAppBarOnBackColor({Color? backColor}) {
    backColor ??= AppThemes.currentTheme.backgroundColor;
    Color replace;
  ...
  AutoSizeText bold() {
    var ts = style ?? AppThemes.currentTheme.baseTextStyle;
    ts = ts.copyWith(fontWeight: FontWeight.bold); // FontWeight.w900 is bigger then FontWeight.bold
  ...
  AutoSizeText fs(double size) {
    var ts = style ?? AppThemes.currentTheme.baseTextStyle;
    ts = ts.copyWith(fontSize: AppSizes.fwFontSize(size)); // FontWeight.w900 is bigger then FontWeight.bold
  ...
  AutoSizeText fsR(double size) {
    final ts = style ?? AppThemes.currentTheme.baseTextStyle;

    return fs(ts.fontSize! + size);
  }
}
///==========================================================================================================
extension TextFieldExtension on TextField {
  TextField intelliWhite() {
    ...
    var ts = style ?? AppThemes.currentTheme.baseTextStyle;
    var dec = decoration ?? InputDecoration();
    ...
    final border = dec.border?? AppThemes.themeData.inputDecorationTheme.border;
    final enabledBorder = dec.enabledBorder?? AppThemes.themeData.inputDecorationTheme.enabledBorder;
    final disabledBorder = dec.disabledBorder?? AppThemes.themeData.inputDecorationTheme.disabledBorder;
    final errorBorder = dec.errorBorder?? AppThemes.themeData.inputDecorationTheme.errorBorder;
    final focusedBorder = dec.focusedBorder?? AppThemes.themeData.inputDecorationTheme.focusedBorder;
    final focusedErrorBorder = dec.focusedErrorBorder?? AppThemes.themeData.inputDecorationTheme.focusedErrorBorder;
...
extension TextFormFieldExtension on TextFormField {
  TextFormField intelliWhite() {
    ...
    var ts = my.style ?? AppThemes.currentTheme.baseTextStyle;
    var dec = my.decoration ?? InputDecoration();
...
extension DropdownButtonExtension on DropdownButton {
  Widget wrap(
    ...
    if(ColorHelper.isNearColors(AppThemes.currentTheme.primaryColor,
        [Colors.grey[900]!, Colors.white, Colors.grey[600]!])) {
      arrowColor ??= AppThemes.currentTheme.appBarItemColor;
    }
    else {
      arrowColor ??= Colors.white;
    }

    final back = backColor?? ColorHelper.changeLight(AppThemes.themeData.colorScheme.secondary); //primaryColor
...
///==========================================================================================================
extension TitleInfoExtension on TitleInfo {
  TitleInfo intelliWhite() {
    Color replace;
    ...
    var titleS = titleStyle?? AppThemes.baseTextStyle();
    var infoS = infoStyle?? AppThemes.baseTextStyle();

    titleS = titleS.copyWith(color: replace);
    infoS = infoS.copyWith(color: replace);
...
///==========================================================================================================
extension TitleIconExtension on TitleIcon {
  TitleIcon intelliWhite() {
    Color replace;
    ...
    var iconS = iconStyle?? AppThemes.baseTextStyle();
    var infoS = infoStyle?? AppThemes.baseTextStyle();

    iconS = iconS.copyWith(color: replace);
    infoS = infoS.copyWith(color: replace);
