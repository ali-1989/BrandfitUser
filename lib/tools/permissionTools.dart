...
class PermissionTools {
	...
	static Future<PermissionStatus> requestCameraStoragePermissions() async {
		...
		final StreamFn s = (String key, StreamController streamCtr) async {
		...
		return StreamCache.get<PermissionStatus>('requestCameraStoragePermissions', s).then((value){
			if(value != null) {
			  return value;
			}
	...
	static Future<PermissionStatus> requestStoragePermission() async {
		...
		final StreamFn fn = (String key, StreamController streamCtr) async {
		...
		return StreamCache.get<PermissionStatus>('requestStoragePermission', fn).then((value){
			if(value != null) {
			  return value;
			}
